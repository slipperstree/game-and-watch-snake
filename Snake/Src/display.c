...
#ifdef UI_LANG_EN
    u8* STR_PRESS_ANY_KEY             = (u8*)"Press Any Key..";
    u8* STR_DEMO_MENU                 = (u8*)"壹 Spd 貳 Snd 叁 Bk";
    u8* STR_GAME_MENU                 = (u8*)"壹 Lft 貳 Fwd 叁 Rgt";
    u8* STR_DEMO_MENU_SOUND           = (u8*)"貳 Snd";
